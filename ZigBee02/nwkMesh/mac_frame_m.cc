...
macFrame::macFrame(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->counter = 0;
    this->numFrames = 0;
    this->framesLeft = 0;
...
int macFrame::getCounter() const
{
    return this->counter;
}

void macFrame::setCounter(int counter)
{
    this->counter = counter;
}

int macFrame::getNumFrames() const
{
    return this->numFrames;
}

void macFrame::setNumFrames(int numFrames)
{
    this->numFrames = numFrames;
}

int macFrame::getFramesLeft() const
{
    return this->framesLeft;
}

void macFrame::setFramesLeft(int framesLeft)
{
    this->framesLeft = framesLeft;
}

int macFrame::getGateNumber() const
{
    return this->gateNumber;
}

void macFrame::setGateNumber(int gateNumber)
{
    this->gateNumber = gateNumber;
}

bool macFrame::getBroadcast() const
{
    return this->broadcast;
}

void macFrame::setBroadcast(bool broadcast)
{
...
int macFrameDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='b' && strcmp(fieldName, "broadcast")==0) return base+4;
...
int macFrameDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string macFrameDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 4: return bool2string(pp->getBroadcast());
        default: return "";
    }
}

bool macFrameDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 4: pp->setBroadcast(string2bool(value)); return true;
...
void *macFrameDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
